...
const Login = () => {
  ...
  return (
    // Changed h-screen to min-h-screen to allow scrolling on small devices
    <div className="min-h-screen w-full bg-[#F4F7F6] font-poppins flex items-center justify-center p-4 md:p-6">
      {/* Container max-height adjusted to be flexible */}
      <div className="w-full max-w-[1000px] bg-white rounded-[2rem] shadow-2xl flex flex-col md:flex-row border border-gray-100 overflow-hidden">

        {/* LEFT SIDE: Brand Visual */}
        <div className="hidden md:flex md:w-5/12 bg-[#02353C] p-12 flex-col justify-between text-white relative">
